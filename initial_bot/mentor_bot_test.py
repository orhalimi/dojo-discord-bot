...
async def on_ready():
    ...
    #   await create_new_channel(guild,'test445')


async def create_new_channel(guild, room_name):
    print(f'Confirmed')
    # role=room_name
    ...
    # }
    channel = await guild.create_text_channel(room_name, topic='Potatos')
    print(dir(channel))
    # await guild.author.add_roles(autorize_role)
